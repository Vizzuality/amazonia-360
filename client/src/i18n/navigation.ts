...
// configuration — and, on top of that, the active country module. Everything that builds
// an in-app URL goes through here, so the scoped/unscoped rule lives in one place.
//
