...
export const gridTileGridTileTileIndexGet = (
  ...
  return API<Blob>(
    { url: `/grid/tile/${tileIndex}`, method: "GET", params, responseType: "blob" },
    options,
  );
};
/**
...
export const gridDatasetMetadataGridMetaGet = (
  options?: SecondParameter<typeof API<MultiDatasetMeta>>,
) => {
...
export const readTableGridTablePost = (
  ...
  options?: SecondParameter<typeof API<TableResults>>,
) => {
