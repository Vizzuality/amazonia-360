...
export default function Sketch() {
  ...
  return (
    <div className="flex w-full rounded-[32px] h-16 text-sm bg-white items-center overflow-hidden">
      <button
        className={cn(
          "grow h-full flex items-center justify-center space-x-2.5 hover:bg-gray-50",
          sketch.enabled &&
            sketch.type === "point" &&
      ...
      <button
        className={cn(
          "grow h-full flex items-center justify-center space-x-2.5 hover:bg-gray-50",
          sketch.enabled &&
            sketch.type === "polyline" &&
            "bg-accent hover:bg-accent/75",
        )}
        onClick={(e) => handleClick(e, "polyline")}
      >
        <svg
          width="21"
          height="20"
