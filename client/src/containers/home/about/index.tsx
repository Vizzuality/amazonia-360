...
const HeroHome = () => {
  ...
  return (
    <Element name="moreInfo" className="-mt-2 w-screen md:mt-0">
      <section
        ref={sectionRef}
        className="relative h-full w-screen overflow-hidden bg-green-800 bg-center text-white md:h-[calc(100svh-calc(var(--spacing)*80)+1px)]"
      >
        <div
          className={`relative h-80 max-h-62.5 w-screen overflow-hidden md:h-[calc(100svh-calc(var(--spacing)*80)+1px)] md:max-h-none md:max-w-none`}
        >
          <div
