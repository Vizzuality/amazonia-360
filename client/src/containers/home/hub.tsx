      ...
      <div className="container">
        <div className="flex max-w-xl flex-col items-start justify-start space-y-8">
          ...
          <p className="max-w-lg font-normal">
            ...
            and partners guide you straight to information about your area of interest. Remove
            access to the Hub. Perhaps a shortcut to the GeoKnow (Knowledge products section?)
          </p>
          <Link href="/hub">
