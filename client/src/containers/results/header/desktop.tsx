  ...
  return (
    <header
      className={cn({
        ...
        "after:absolute after:inset-0 after:top-full after:left-0 after:-z-10 after:h-6 after:w-full after:bg-linear-to-b after:from-blue-50 after:to-blue-50/0": true,
      })}
    >
