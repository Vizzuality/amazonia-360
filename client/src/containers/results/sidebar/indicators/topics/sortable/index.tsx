    ...
    >
      ...
      <DragOverlay>
        {isValidElement(ActiveItem) && (
          <div className="flex max-h-[calc(100vh_-_calc(var(--spacing)*16)_-_calc(var(--spacing)*6)_-_calc(var(--spacing)*48)_-_calc(var(--spacing)*40))] flex-col overflow-hidden">
            {cloneElement(
