      ...
      <div className="container">
        <div className="space-y-2">
          <p className="font-medium text-sm">
            The maps, data, and geographic information presented on
            AmazoniaForever360+ are provided for reference purposes only and are
            intended solely to enhance territorial knowledge of the Amazonia
            Forever program&apos;s work area.
          </p>

          <p className="font-medium text-sm">
            International boundary lines and other administrative delimitations
            used by AmazoniaForever360+ are sourced from carefully selected and
            ...
            held by the Inter-American Development Bank (IDB) regarding
            international borders, disputes, or claims between countries.
          </p>

          <p className="font-medium text-sm">
            This material is not suitable for precision applications,
            navigation, or emergency situations. AmazoniaForever360+ and its
