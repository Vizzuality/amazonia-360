...
# Shared RDS PostgreSQL database for all environments
# All environments are in sa-east-1 region and will access this database
module "database" {
  source = "./modules/database"
  providers = {
    aws = aws.prod # Using prod provider as all envs are in sa-east-1
  }
...
module "dev" {
  ...
  github_additional_environment_variables = {
    ...
    TF_DATABASE_URL = "postgres://${module.dev.db_username}@${module.database.db_instance_address}:${module.database.db_instance_port}/${module.dev.db_name}"
  ...
  github_additional_environment_secrets = {
    ...
    # Database - password for the instance-specific db user
    TF_DATABASE_PASSWORD = module.dev.db_password
...
module "staging" {
  ...
  github_additional_environment_variables = {
    ...
    # Database - instance-specific database on a shared db instance; user
    # password is added into URL at runtime by the client app
    TF_DATABASE_URL = "postgres://${module.staging.db_username}@${module.database.db_instance_address}:${module.database.db_instance_port}/${module.staging.db_name}"
  ...
  github_additional_environment_secrets = {
    ...
    # Database - password for the instance-specific db user
    TF_DATABASE_PASSWORD = module.staging.db_password
...
module "prod" {
  ...
  github_additional_environment_variables = {
    ...
    # Database - instance-specific database on a shared db instance; user
    # password is added into URL at runtime by the client app
    TF_DATABASE_URL = "postgres://${module.prod.db_username}@${module.database.db_instance_address}:${module.database.db_instance_port}/${module.prod.db_name}"
  ...
  github_additional_environment_secrets = {
    ...
    # Database - password for the instance-specific db user
    TF_DATABASE_PASSWORD = module.prod.db_password
